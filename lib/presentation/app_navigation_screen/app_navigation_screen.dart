...
class AppNavigationScreen extends StatelessWidget {
                                ...
                                child: Container(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                              onTap: () {
                                                onTapSetupGPSlocations(context);
                                              },
                                              child: Container(
                                                  decoration: AppDecoration
                                                      .fillWhiteA700,
  ...
  onTapSplashScreenTwo(BuildContext context) {
  ...
  onTapSetupGPSlocations(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.setupGpsLocationsScreen,
    );
  }

  /// Navigates to the optionsOneScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `NavigatorService`
  /// to push the named route for the optionsOneScreen.
  onTapOptionsOne(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.optionsOneScreen,
    );
  }
  ...
  onTapPhoneVerify(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.phoneVerifyScreen,
    );
  }
